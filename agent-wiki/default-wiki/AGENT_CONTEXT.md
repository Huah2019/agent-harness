...
1. [核心设计](./design/core-design.md) — agent-wiki 的核心设计是 Skill 负责约束 agent 行为，Go CLI 负责约束知识库文件系统写入。 · 更新于 2026-09-10
2. [软链 skill 的 wiki_root 解析](./pitfalls/symlinked-skill-wiki-root.md) — 软链安装 agent-wiki skill 时,相对 wiki_root 会按真实 skill 目录解析,容易指到不存在的知识库。 · 更新于 2026-06-10
