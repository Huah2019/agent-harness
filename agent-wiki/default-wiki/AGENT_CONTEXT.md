...
1. [核心设计](./design/core-design.md) — agent-wiki 的核心设计是 Skill 负责约束 agent 行为，Go CLI 负责约束知识库文件系统写入。 · 更新于 2026-05-10
2. [当前演进队列](./evolution/current-roadmap.md) — 记录 agent-harness 让项目知识库持续驱动 agent 改进的近期演进方向。 · 更新于 2026-05-10
3. [agent-wiki 边界与常见误区](./pitfalls/agent-wiki-boundaries.md) — 记录 agent-wiki 使用时最容易破坏项目知识库一致性的边界和误区。 · 更新于 2026-05-10
4. [项目工作闭环](./runbooks/development-loop.md) — 说明 agent 在 agent-harness 中如何读取知识、执行改动、验证并沉淀经验。 · 更新于 2026-05-10
<!-- END: recent -->
